...
import beta_nlp.utils.evaluation as eval_model
from beta_nlp.utils.common import print_dict_as_table, save_to_csv, timeit
...
class SeqEvalEngine(object):
    ...
    def test_eval_seq(self, test_data, recommender):
        ...
        for TOPN in TOPNs:
            ...
            for mname, mvalue in zip(METRICS.keys(), test_results):
                print("	{}@{}: {:.4f}".format(mname, TOPN, mvalue)).utils.evaluation as eval_model
...
class SeqEvalEngine(object):
    ...
    def test_eval_seq(self, test_data, recommender):
        ...
        for TOPN in TOPNs:
            ...
            for mname, mvalue in zip(METRICS.keys(), test_results):
                print("	{}@{}: {:.4f}".format(mname, TOPN, mvalue)).utils.common_util import print_dict_as_table, save_to_csv, timeit
...
class SeqEvalEngine(object):
    ...
    def test_eval_seq(self, test_data, recommender):
        ...
        for TOPN in TOPNs:
            ...
            for mname, mvalue in zip(METRICS.keys(), test_results):
                print("	{}@{}: {:.4f}".format(mname, TOPN, mvalue)).utils.constants import (
    DEFAULT_ITEM_COL,
...
class SeqEvalEngine(object):
    ...
    def test_eval_seq(self, test_data, recommender):
        ...
        for TOPN in TOPNs:
            ...
            for mname, mvalue in zip(METRICS.keys(), test_results):
                print("	{}@{}: {:.4f}".format(mname, TOPN, mvalue)).utils.seq_evaluation import mrr, ndcg, precision, recall
